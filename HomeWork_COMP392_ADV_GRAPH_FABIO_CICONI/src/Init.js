...
function guiControls() {
    ...
    //tetrahedronFolder
    var tetrahedronFolder = gui.addFolder("Tetrahedron_");
    tetrahedronFolder.add(controls, "tetrahedronPositionX", 0, 10).onChange(c => tetrahedron.position.x = c);
    tetrahedronFolder.add(controls, "tetrahedronPositionY", 0, 10).onChange(c => tetrahedron.position.y = c);
    tetrahedronFolder.add(controls, "tetrahedronPositionZ", 0, 10).onChange(c => tetrahedron.position.z = c);

    tetrahedronFolder.add(controls, "tetrahedronRotationX", 0, 10).onChange(c => tetrahedron.rotation.x = c);
    tetrahedronFolder.add(controls, "tetrahedronRotationY", 0, 10).onChange(c => tetrahedron.rotation.y = c);
    tetrahedronFolder.add(controls, "tetrahedronRotationZ", 0, 10).onChange(c => tetrahedron.rotation.z = c);

    tetrahedronFolder.add(controls, "tetrahedronScaleX", 0, 10).onChange(c => tetrahedron.scale.x = c);
    tetrahedronFolder.add(controls, "tetrahedronScaleY", 0, 10).onChange(c => tetrahedron.scale.y = c);
    tetrahedronFolder.add(controls, "tetrahedronScaleZ", 0, 10).onChange(c => tetrahedron.scale.z = c);

    tetrahedronFolder.add(controls, "tetrahedronWireframe", false, true).onChange(c => tetrahedron.material.wireframe = c);
    tetrahedronFolder.add(controls, "tetrahedronVisible", false, true).onChange(c => tetrahedron.visible = c);
